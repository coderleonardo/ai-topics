...
Before using any tool, evaluate the available tools and check if it is possible to extract the necessary arguments for the tool from the user's question. 
If it is not possible or does not make sense, return <I cannot answer this question>
